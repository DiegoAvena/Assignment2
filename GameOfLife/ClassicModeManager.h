...
run using the correct settings for Classic mode

*/
class ClassicModeManager: public GenericBoundaryMode {
...
public:
  ClassicModeManager(); //default constructor
  ~ClassicModeManager(); //destructor
